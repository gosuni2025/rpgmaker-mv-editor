...
- [エディタ概要・画面構成](docs/01-overview.md)
- [マップエディタ](docs/02-map-editor.md) — タイル編集、ライティング、オブジェクト、フォグ
- [3D モード](docs/03-3d-mode.md) — カメラ操作、レンダリング、スカイボックス
- [UI エディタ](docs/04-ui-editor.md) — スキンシステム、カスタムシーン
- [プラグイン一覧](docs/05-plugins.md) — 同梱 14 プラグインのドキュメント
- [イベントエディタ](docs/06-event-editor.md) — コマンド編集、スクリプト、移動ルート、条件分岐

## AI 連携 (MCP)

MCP (Model Context Protocol) サーバーを内蔵しており、Claude がエディタを直接操作できます。マップ生成、イベント作成、データベース編集などを自然言語で依頼できます。

**設定方法**: [docs/mcp-setup.md](docs/mcp-setup.md)
