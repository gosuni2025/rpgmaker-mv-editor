const en = {
  ...
  options: {
    ...
    steamOpenFolder: 'Open Folder',
    steamFillWindows: 'Windows Default',
    steamFillMac: 'macOS Default',
    steamFillLinux: 'Linux Default',
    steamOpenSettings: 'View settings.json',
  ...
  fields: {
    ...
    face: 'Face',
    character: 'Character',
    battlerSV: 'Battler (SV)',
    initialEquipment: 'Initial Equipment',
    equipSlots: {
      weapon: 'Weapon',
      shield: 'Shield',
      head: 'Head',
    ...
    message1: 'Message 1',
    message2: 'Message 2',
    requiredWeaponTypes: 'Required Weapon Types',
    requiredWeaponType1: 'Required Weapon Type 1',
    requiredWeaponType2: 'Required Weapon Type 2',
    ...
    priority: 'Priority',
    removalConditions: 'Removal Conditions',
    ...
    chanceByDamage: 'Chance by Damage (%)',
    removeByWalking: 'Remove by Walking',
    stepsToRemove: 'Steps to Remove',
    svSideView: 'SV (Side View)',
    svMotion: 'SV Motion',
    svOverlay: 'SV Overlay',
    messages: 'Messages',
    message1Actor: 'Message 1 (Actor)',
    message2Enemy: 'Message 2 (Enemy)',
    message3Persist: 'Message 3 (Persist)',
    message4Remove: 'Message 4 (Remove)',
    tilesetImages: 'Tileset Images',
    trigger: 'Trigger',
    switchId: 'Switch ID',
    level: 'Level',
    expCurve: 'EXP Curve',
    paramCurves: 'Parameter Curves (Level 1 / Level 99)',
    learnings: 'Learnings',
  },
  ...
  expParams: {
    ...
    accelerationA: 'Acceleration A',
    accelerationB: 'Acceleration B',
  },
  ...
  scope: {
    ...
    randomEnemy1: '1 Random Enemy',
    randomEnemy2: '2 Random Enemies',
    randomEnemy3: '3 Random Enemies',
    randomEnemy4: '4 Random Enemies',
    oneAlly: '1 Ally',
    allAllies: 'All Allies',
    oneAllyDead: '1 Ally (Dead)',
    allAlliesDead: 'All Allies (Dead)',
    theUser: 'The User',
  },
  ...
  occasion: {
    ...
    onlyFromMenu: 'Only from Menu',
    never: 'Never',
  },

  hitType: {
    certainHit: 'Certain Hit',
  ...
  dropKind: { none: 'None', item: 'Item', weapon: 'Weapon', armor: 'Armor' },

  conditionType: {
    always: 'Always', turn: 'Turn', hp: 'HP', mp: 'MP',
    state: 'State', partyLevel: 'Party Level', switch: 'Switch',
  },

  spanOptions: { battle: 'Battle', turn: 'Turn', moment: 'Moment' },

  restriction: {
    none: 'None', attackEnemy: 'Attack an enemy', attackAnyone: 'Attack anyone',
    attackAlly: 'Attack an ally', cannotMove: 'Cannot move',
  },

  autoRemoval: { none: 'None', actionEnd: 'Action End', turnEnd: 'Turn End' },

  svMotion: { normal: 'Normal', abnormal: 'Abnormal', sleep: 'Sleep', dead: 'Dead' },

  svOverlay: {
    none: 'None', poison: 'Poison', blind: 'Blind', silence: 'Silence',
    rage: 'Rage', confusion: 'Confusion', fascination: 'Fascination',
    sleep: 'Sleep', paralyze: 'Paralyze', curse: 'Curse',
  },

  tilesetMode: { field: 'Field', area: 'Area' },

  triggerOptions: { none: 'None', autorun: 'Autorun', parallel: 'Parallel' },

  typeCategories: {
    elements: 'Elements', skillTypes: 'Skill Types', weaponTypes: 'Weapon Types',
    armorTypes: 'Armor Types', equipTypes: 'Equip Types',
  },

  termsTab: { basic: 'Basic', commands: 'Commands', params: 'Params', messages: 'Messages' },
  ...
  traits: {
    ...
    xparams: {
      0: 'Hit Rate', 1: 'Evasion', 2: 'Critical', 3: 'Crit Evasion', 4: 'Magic Evasion',
      5: 'Magic Reflect', 6: 'Counter', 7: 'HP Regen', 8: 'MP Regen', 9: 'TP Regen',
    },
    sparams: {
      0: 'Target Rate', 1: 'Guard Effect', 2: 'Recovery', 3: 'Pharmacology', 4: 'MP Cost',
      5: 'TP Charge', 6: 'Physical Damage', 7: 'Magical Damage', 8: 'Floor Damage', 9: 'EXP Rate',
    },
    specialFlags: { 0: 'Auto Battle', 1: 'Guard', 2: 'Substitute', 3: 'Preserve TP' },
    collapseEffects: { 0: 'Boss', 1: 'Instant', 2: 'Not Disappear' },
    partyAbilities: {
      0: 'Encounter Half', 1: 'Encounter None', 2: 'Cancel Surprise',
      3: 'Raise Preemptive', 4: 'Gold Double', 5: 'Drop Item Double',
    },
  },
  ...
  eventCommands: {
    ...
    categories: {
      // Tab 1
      'tab1Messages': 'Messages',
      'tab1GameProgression': 'Game Progression',
      'tab1FlowControl': 'Flow Control',
      'tab1Party': 'Party',
      'tab1Actor': 'Actor',
      // Tab 2
      'tab2Movement': 'Movement',
      'tab2Character': 'Character',
      'tab2Picture': 'Picture',
      'tab2Timing': 'Timing',
      'tab2Screen': 'Screen',
      'tab2AudioVideo': 'Audio & Video',
      // Tab 3
      'tab3SceneControl': 'Scene Control',
      'tab3SystemSettings': 'System Settings',
      'tab3Map': 'Map',
      'tab3Battle': 'Battle',
      'tab3Advanced': 'Advanced',
    },
    commands: {
      // Tab 1 - Messages
      101: 'Show Text...', 102: 'Show Choices...', 103: 'Input Number...',
      ...
      119: 'Jump to Label...', 108: 'Comment...',
      // Tab 1 - Party
      125: 'Change Gold...', 126: 'Change Items...', 127: 'Change Weapons...',
      128: 'Change Armors...', 129: 'Change Party Member...',
      // Tab 1 - Actor
      311: 'Change HP...', 312: 'Change MP...', 326: 'Change TP...',
      313: 'Change State...', 314: 'Recover All...', 315: 'Change EXP...',
      316: 'Change Level...', 317: 'Change Parameter...', 318: 'Change Skill...',
      319: 'Change Equipment...', 320: 'Change Name...', 321: 'Change Class...',
      324: 'Change Nickname...', 325: 'Change Profile...',
      // Tab 2 - Movement
      201: 'Transfer Player...', 202: 'Set Vehicle Location...',
      203: 'Set Event Location...', 204: 'Scroll Map...',
      205: 'Set Movement Route...', 206: 'Get On/Off Vehicle',
      // Tab 2 - Character
      211: 'Change Transparency...', 216: 'Change Player Followers...',
      217: 'Gather Followers', 212: 'Show Animation...',
      213: 'Show Balloon Icon...', 214: 'Temporarily Erase Event',
      // Tab 2 - Picture
      231: 'Show Picture...', 232: 'Move Picture...', 233: 'Rotate Picture...',
      234: 'Tint Picture...', 235: 'Erase Picture...',
      // Tab 2 - Timing
      230: 'Wait...',
      // Tab 2 - Screen
      221: 'Fadeout Screen', 222: 'Fadein Screen', 223: 'Tint Screen...',
      224: 'Flash Screen...', 225: 'Shake Screen...', 236: 'Set Weather Effect...',
      // Tab 2 - Audio & Video
      241: 'Play BGM...', 242: 'Fadeout BGM...', 243: 'Save BGM', 244: 'Replay BGM',
      245: 'Play BGS...', 246: 'Fadeout BGS...', 249: 'Play ME...', 250: 'Play SE...',
      251: 'Stop SE', 261: 'Play Movie...',
      // Tab 3 - Scene Control
      301: 'Battle Processing...', 302: 'Shop Processing...',
      303: 'Name Input Processing...', 351: 'Open Menu Screen',
      352: 'Open Save Screen', 353: 'Game Over', 354: 'Return to Title Screen',
      ...
      322: 'Change Actor Images...', 323: 'Change Vehicle Image...',
      // Tab 3 - Map
      281: 'Change Map Name Display...', 282: 'Change Tileset...',
      283: 'Change Battle Back...', 284: 'Change Parallax...',
      285: 'Get Location Info...',
      // Tab 3 - Battle
      331: 'Change Enemy HP...', 332: 'Change Enemy MP...',
      333: 'Change Enemy TP...', 334: 'Change Enemy State...',
      335: 'Enemy Recover All...', 336: 'Enemy Appear...',
      337: 'Enemy Transform...', 338: 'Show Battle Animation...',
    ...
    display: {
      101: 'Show Text', 102: 'Show Choices', 103: 'Input Number',
      104: 'Select Item', 105: 'Show Scrolling Text', 108: 'Comment',
      111: 'If', 112: 'Loop', 113: 'Break Loop', 115: 'Exit Event Processing',
      ...
      134: 'Change Save Access', 135: 'Change Menu Access',
      136: 'Change Encounter', 137: 'Change Formation Access',
      138: 'Change Window Color', 139: 'Change Defeat ME',
      140: 'Change Vehicle BGM',
      201: 'Transfer Player', 202: 'Set Vehicle Location',
      203: 'Set Event Location', 204: 'Scroll Map',
      205: 'Set Movement Route', 206: 'Get On/Off Vehicle',
      211: 'Change Transparency', 212: 'Show Animation',
      213: 'Show Balloon Icon', 214: 'Temporarily Erase Event',
      ...
      331: 'Change Enemy HP', 332: 'Change Enemy MP', 333: 'Change Enemy TP',
      334: 'Change Enemy State', 335: 'Enemy Recover All', 336: 'Enemy Appear',
      337: 'Enemy Transform', 338: 'Show Battle Animation', 339: 'Force Action',
      340: 'Abort Battle',
      ...
      601: 'If Win', 602: 'If Escape', 603: 'If Lose', 604: 'End', 655: ':',
    },
  },
  ...
  eventList: {
    title: 'EVENTS',
    newEvent: '+ New',
    noEvents: 'No events on this map',
    position: 'Position',
    pages: 'Pages',
    contextNew: 'New Event',
    contextEdit: 'Edit',
    contextCopy: 'Copy',
    contextCut: 'Cut',
  ...
  eventDetail: {
    ...
    image: 'Image',
    autonomousMovement: 'Autonomous Movement',
    type: 'Type',
    frequency: 'Frequency',
    options: 'Options',
    walkingAnimation: 'Walking Animation',
    steppingAnimation: 'Stepping Animation',
    directionFix: 'Direction Fix',
    through: 'Through',
    priorityAndTrigger: 'Priority & Trigger',
    moveTypes: { 0: 'Fixed', 1: 'Random', 2: 'Approach', 3: 'Custom' },
    moveSpeeds: { 0: 'x8 Slower', 1: 'x4 Slower', 2: 'x2 Slower', 3: 'Normal', 4: 'x2 Faster', 5: 'x4 Faster' },
    moveFreqs: { 0: 'Lowest', 1: 'Lower', 2: 'Normal', 3: 'Higher', 4: 'Highest' },
    priorityTypes: { 0: 'Below characters', 1: 'Same as characters', 2: 'Above characters' },
    triggerTypes: { 0: 'Action Button', 1: 'Player Touch', 2: 'Event Touch', 3: 'Autorun', 4: 'Parallel' },
    conditionSwitch1: 'Switch 1',
    conditionSwitch2: 'Switch 2',
  ...
  mapProperties: {
    ...
    scrollTypes: { 0: 'No Loop', 1: 'Loop Vertically', 2: 'Loop Horizontally', 3: 'Loop Both' },
    encSteps: 'Enc. Steps',
    autoplay: 'Autoplay',
    autoplayBGM: 'Autoplay BGM',
    autoplayBGS: 'Autoplay BGS',
    bgmName: 'BGM Name',
    bgsName: 'BGS Name',
    options: 'Options',
    specifyBattleback: 'Specify Battleback',
    disableDashing: 'Disable Dashing',
  ...
  mapTree: {
    openProject: 'Please open a project',
    project: 'Project',
    newMap: 'New Map...',
  ...
  animations: {
    ...
    hue: 'Hue',
    position: 'Position',
    positions: { 0: 'Head', 1: 'Center', 2: 'Feet', 3: 'Screen' },
    timing: 'Timing',
    flashScope: 'Flash Scope',
    flashScopes: { 0: 'None', 1: 'Target', 2: 'Screen', 3: 'Hide Target' },
    duration: 'Duration',
    flashColor: 'Flash Color (RGBA)',
  },

  system: {
    initialParty: 'Initial Party',
    gameTitle: 'Game Title',
    currency: 'Currency Unit',
    locale: 'Locale',
    vehicleImages: 'Vehicle Images',
    vehicles: { boat: 'Boat', ship: 'Ship', airship: 'Airship' },
    ...
    music: 'Music',
    musicLabels: { title: 'Title', battle: 'Battle', victory: 'Victory', defeat: 'Defeat', gameover: 'Game Over' },
    menuCommands: 'Menu Commands',
    menuItems: { 0: 'Item', 1: 'Skill', 2: 'Equip', 3: 'Status', 4: 'Formation', 5: 'Save' },
    attackMotion: '[SV] Attack Motion',
    motionTypes: { 0: 'Thrust', 1: 'Swing', 2: 'Missile' },
    magicSkills: '[SV] Magic Skills',
    options: 'Options',
    optSideView: 'Use Side-view Battle',
    optTransparent: 'Start Transparent',
    optFollowers: 'Show Player Followers',
    optSlipDeath: 'KO by Slip Damage',
    optFloorDeath: 'KO by Floor Damage',
    optDisplayTp: 'Display TP in Battle',
    optExtraExp: 'EXP for Reserve Members',
    soundEffects: 'Sound Effects',
    soundNames: {
      0: 'Cursor', 1: 'OK', 2: 'Cancel', 3: 'Buzzer', 4: 'Equip', 5: 'Save', 6: 'Load', 7: 'Battle Start',
      8: 'Escape', 9: 'Enemy Attack', 10: 'Enemy Damage', 11: 'Enemy Collapse', 12: 'Boss Collapse 1',
      13: 'Boss Collapse 2', 14: 'Actor Damage', 15: 'Actor Collapse', 16: 'Recovery', 17: 'Miss',
      18: 'Evasion', 19: 'Magic Evasion', 20: 'Magic Reflection', 21: 'Shop', 22: 'Use Item', 23: 'Use Skill',
    },
  ...
  openProject: {
    ...
    projectDetected: 'RPG Maker MV project detected',
  ...
  migration: {
    ...
    status: 'Status',
    editorSize: 'Editor',
    editorMtime: 'Editor Date',
    projectSize: 'Project',
    projectMtime: 'Project Date',
    statusAdd: 'New',
  ...
  find: {
    ...
    typeName: 'Name',
    typeSwitch: 'Switch ID',
    typeVariable: 'Variable ID',
    searching: 'Searching...',
    search: 'Search',
    resultsPlaceholder: 'Search results will appear here',
    resultsCount: '{{count}} results found ({{current}}/{{total}})',
    prev: 'Previous',
    next: 'Next',
  },
  ...
  eventSearch: {
    ...
    pageHeader: 'Page',
    resultsPlaceholder: 'Search results will appear here',
    resultsCount: '{{count}} results found — double-click to navigate',
  },
  ...
  deploy: {
    ...
    platform: 'Platform',
    platformDesc: {
      web: 'Deploy as web browser playable',
      windows: 'Deploy as Windows executable',
      macos: 'Deploy as macOS application',
    },
    options: 'Options',
    excludeUnused: 'Exclude unused files',
