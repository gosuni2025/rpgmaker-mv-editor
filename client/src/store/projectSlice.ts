  ...
  restoreLastProject: async () => {
    ...
    try {
      ...
      if (toolbarRaw) {
        ...
        if (typeof tb.uiEditSubMode === 'string' && ['window', 'frame', 'cursor', 'gauge'].includes(tb.uiEditSubMode)) updates.uiEditSubMode = tb.uiEditSubMode as EditorState['uiEditSubMode'];
