...
function getCommandName(code: number): string {
  const names: Record<number, string> = {
    ...
    331: '적 HP 변경', 332: '적 MP 변경', 333: '적 스테이트의 변경', 334: '적 캐릭터의 완전 회복', 335: '적 캐릭터의 출현', 336: '적 캐릭터의 변신', 342: '적 TP 변경',
...
function getEditorContent(
  ...
  switch (code) {
    ...
    case 334: return <EnemyRecoverAllEditor p={p} onOk={onOk} onCancel={onCancel} />;
