...
const WIDGET_TYPE_COLORS: Record<WidgetType, string> = {
  ...
  button: '#2675bf', list: '#2a7a3a', textList: '#3a8a3a', options: '#7a5a2a',
...
const WIDGET_TYPE_LABELS: Record<WidgetType, string> = {
  ...
  button: 'BTN', list: 'LIST', textList: 'TXTLIST', options: 'OPTS',
...
export function AddWidgetMenu({ sceneId, parentId, onClose }: { sceneId: string; parentId: string; onClose: () => void }) {
  ...
  const types: WidgetType[] = ['background', 'panel', 'label', 'textArea', 'image', 'gauge', 'separator', 'button', 'list', 'textList', 'options', 'minimap', 'scene'];
