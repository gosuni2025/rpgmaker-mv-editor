export type Tab = 'netlify' | 'ghpages' | 'itchio' | 'local' | 'localpreview';
...
export type SSEEvent =
  ...
  | { type: 'done'; zipPath?: string; deployUrl?: string; siteUrl?: string; commitHash?: string; pageUrl?: string; buildId?: string; gameId?: string; previewUrl?: string }
