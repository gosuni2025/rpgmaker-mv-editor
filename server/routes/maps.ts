...
/** ext 파일로 분리할 확장 필드 */
const EXTENSION_FIELDS = ['editorLights', 'objects', 'cameraZones', 'skyBackground', 'animTileSettings', 'bloomConfig', 'postProcessConfig', 'fogOfWar', 'testStartPosition', 'eventFoldState'];
